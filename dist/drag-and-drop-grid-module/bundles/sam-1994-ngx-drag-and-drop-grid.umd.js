(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/drag-drop'), require('@angular/cdk/overlay'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@sam-1994/ngx-drag-and-drop-grid', ['exports', '@angular/core', '@angular/cdk/drag-drop', '@angular/cdk/overlay', '@angular/common'], factory) :
    (global = global || self, factory((global['sam-1994'] = global['sam-1994'] || {}, global['sam-1994']['ngx-drag-and-drop-grid'] = {}), global.ng.core, global.ng.cdk['drag-drop'], global.ng.cdk.overlay, global.ng.common));
}(this, function (exports, core, dragDrop, overlay, common) { 'use strict';
    ...
    var SamDragAndDropListContentOutletDirective = /** @class */ (function () {
        ...
        SamDragAndDropListContentOutletDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[samContentOutlet]' },] }
        ];
        /** @nocollapse */
    ...
    var SamDragAndDropGridComponent = /** @class */ (function () {
        ...
        function () {
            ...
            if (this.sourceIndex !== this.targetIndex) {
                dragDrop.moveItemInArray(this.items, this.sourceIndex, this.targetIndex);
                this.renderItems();
            }
        };
        ...
        SamDragAndDropGridComponent.propDecorators = {
            ...
            columnNumber: [{ type: core.Input }],
            contentOutlet: [{ type: core.ViewChildren, args: [SamDragAndDropListContentOutletDirective,] }],
            dragAndDropListData: [{ type: core.ContentChildren, args: [SamDragAndDropListDataDirective,] }],
    ...
    exports.SamDragAndDropGridComponent = SamDragAndDropGridComponent;
    exports.SamDragAndDropGridModule = SamDragAndDropGridModule;
    exports.SamDragAndDropListContentOutletDirective = SamDragAndDropListContentOutletDirective;
    exports.SamDragAndDropListDataDirective = SamDragAndDropListDataDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=sam-1994-ngx-drag-and-drop-grid.umd.js.map
